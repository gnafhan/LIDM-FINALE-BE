...
export interface ApiClassClass extends Schema.CollectionType {
  ...
  attributes: {
    ...
    nama_pengajar: Attribute.String;
    gambar_kelas: Attribute.Media & Attribute.Required;
...
export interface ApiModuleModule extends Schema.CollectionType {
  ...
  attributes: {
    module_title: Attribute.String & Attribute.Required;
...
export interface ApiQuizQuiz extends Schema.CollectionType {
  ...
  attributes: {
    quiz_title: Attribute.String & Attribute.Required;
    is_done: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
